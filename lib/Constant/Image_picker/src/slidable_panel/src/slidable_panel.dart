...
class PanelSetting {
  ...
  String toString() {
    ...
    PanelSetting(
      ...
      headerBackground: ${getPlatformBrightness() ?  Colors.black : Con_white}, 
      foregroundColor: ${getPlatformBrightness() ?  Colors.black : Con_white}, 
      backgroundColor: ${getPlatformBrightness() ?  Colors.black : Con_white}, 
